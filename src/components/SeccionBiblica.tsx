...
export default function SeccionBiblica() {
    ...
    return (
        <div className='flex items-center flex-col mt-10 bg-orange-200 h-min pb-4 w-2/3 rounded-2xl border-opacity-30 shadow-md border-logo border-2'>
            <div className='bg-orange-100 bg-opacity-70 mt-7 h-1/5 w-full flex flex-row items-center pl-7'>
            ...
            <div className='w-full flex items-center flex-col mt-10 gap-4'>
