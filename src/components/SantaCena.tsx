    ...
    return (
        <div className='mt-3 rounded-lg text-center'>
            ...
            <div className='flex xl:flex-row flex-col justify-evenly items-center xl:py-6 py-3'>
                <img src={santaCenaImg.src} alt='' className='xl:h-56 rounded-lg' />
                <div className='xl:w-1/2 py-7 xl:py-0'>
                    <p className='xl:text-xl text-lg font-merriweather xl:w-full opacity-80'>
                ...
                <img src={santaCenaImg2.src} alt='' className='xl:h-56 rounded-lg' />
            </div>
        </div>
    )
}
